...
//        bodyPosition.set(x + tower.getWidth() - WIDTH - 16) * LevelScreen.scaleX, y - 128);  // позиция тела
        bodyPosition.set(bodyPosition.x * LevelScreen.scaleX, bodyPosition.y * LevelScreen.scaleY);
